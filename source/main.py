...
class MyDisplay(Display):
    def _do(self, algorithm):
        ...
        self.add_attributes('min', algorithm.f_pop.std(), width=2)
        self.add_attributes('mean', algorithm.f_pop.mean(), width=2)
        self.add_attributes('elite', algorithm.opt, width=2)
